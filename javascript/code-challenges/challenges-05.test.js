...
const addPurchases = (arr) => arr.reduce((x,y) => x + y.purchasePrice, 0);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const countNumberOfElements = (arr) => arr.reduce(x => ++x, 0);
...
const returnNames = (arr) => arr.reduce((x,y) => x.concat(y.name), []);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
